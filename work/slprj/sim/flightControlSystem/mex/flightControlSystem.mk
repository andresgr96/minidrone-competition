...
MODULES              = flightControlSystem_msf.c c_mexapi_version.c lccstub.c
...
START_DIR            = C:/Users/andre/MATLAB/Projects/examples/MinidroneCompetition/work
...
MODELREF_LINK_LIBS        = C:/Users/andre/MATLAB/Projects/examples/MinidroneCompetition/work/slprj/sim/flightControlSystem/flightControlSystemlib.lib
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/flightControlSystem \
...
flightControlSystem_msf.obj : $(START_DIR)/slprj/sim/flightControlSystem/flightControlSystem_msf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/sim/flightControlSystem/flightControlSystem_msf.c
